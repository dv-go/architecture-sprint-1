```
# ВАЖНО!!!Ссылка на вторую часть задания: https://drive.google.com/file/d/11O8JLkij--Rd0rRkzOz5K-sF1roZQBMc/view?usp=sharing
...
2. **PhotoManagement**
   ...
   - Отвечает за добавление и удаление фотографий.
...
Затем повторите этот процесс для каждого из остальных микрофронтендов: `PhotoManagement`, `LikePhoto`, `ProfileManagement`.
